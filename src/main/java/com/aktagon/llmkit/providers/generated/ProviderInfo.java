 ...
 * stable catalogue (typed identity, env var, default model, base URL).
 */
public record ProviderInfo(
    ...
    /** Public metadata for every provider, sorted by slug (extract.py orders providers alphabetically). */
