...
public final class Catalogue {
     ...
     * model. The hand-coded runtime in Models.java materialises an owned
    ...
    /**
     * (ProviderName, modelId) -> capabilities lookup — consulted by the
     * live-path parsers to enrich ModelInfo records with capability data
     * the wire never carries. Returns null when the SDK has no ontology
     * entry for the pair.
     */
     ...
     * without a live endpoint return null; ScopedModels.list then throws
     * a CatalogueException with kind "not_supported".
     */
    ...
    /** Live-catalogue config for a provider, or null when it has no live endpoint. */
